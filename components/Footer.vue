...
<template>
  <!-- ========== FOOTER ========== -->
  <footer class="mt-4 pt-8 w-full max-w-5xl mx-auto text-sm py-8 border-t border-gray-200 dark:border-neutral-700">
    <!-- Grid -->
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-8">
      ...
      <div>
        <h4 class="text-xs font-semibold text-gray-900 uppercase dark:text-neutral-100">Overview</h4>
      ...
      <div>
        <h4 class="text-xs font-semibold text-gray-900 uppercase dark:text-neutral-100">Image Products
        </h4>
      ...
      <div>
        <h4 class="text-xs font-semibold text-gray-900 uppercase dark:text-neutral-100">Support</h4>

        <div class="mt-3 grid space-y-3 text-sm">
          <p>
            <a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-hidden focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
              href="mailto:erkan@erkansivas.xyz">
              Contact
            </a>
          </p>
        </div>
      ...
      <div v-if="false">
        ...
        <div class="mt-3 grid space-y-3 text-sm">
          <!-- Social Brands -->
          <div class="space-x-4">
            <a class="inline-block text-gray-500 hover:text-gray-800 focus:outline-hidden focus:text-gray-800 dark:text-neutral-500 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
              href="#">
